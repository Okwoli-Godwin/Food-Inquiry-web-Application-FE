      ...
      <div className="w-[100%] flex justify-center">
        <div className="w-[95%] flex h-[100%] mt-[65px] flex-wrap justify-between md:justify-center">
          ...
          <div className="w-[390px] h-[100%] mb-[30px] rounded-lg flex-col overflow-hidden shadow-md object-fit: cover relative">
            <img
              src="https://media.istockphoto.com/id/1265268905/photo/barbecue-chicken-jollof-rice.jpg?s=612x612&w=0&k=20&c=ohtrgIislco_-79g8I6AijYUJ2Yt923weh029-N7MUE="
              alt=""
          ...
          <div className="w-[390px] h-[100%] mb-[30px] rounded-lg flex-col overflow-hidden shadow-md object-fit-cover relative">
            <img
              src="https://media.istockphoto.com/id/1398349816/photo/oha-soup.jpg?s=612x612&w=0&k=20&c=9IMVj6aGvW62S3R11KcTk5TptUaTq1gF-W0wWQtV3HA="
              alt=""
              className="w-[100%] h-[250px] transition duration-500 group-hover:scale-105 object-cover"
            />
